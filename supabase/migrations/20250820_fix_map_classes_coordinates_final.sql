-- Fix map_classes view to properly extract coordinates from geography field
-- This migration ensures the view returns latitude and longitude values

-- First drop the existing view
DROP VIEW IF EXISTS map_classes CASCADE;

-- Recreate with proper coordinate extraction using PostGIS functions
...
COMMENT ON VIEW map_classes IS 'Provides class instance data with extracted location coordinates for map display';